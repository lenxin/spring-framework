...
[subs="verbatim,quotes"]
----
	// the service interface that we want to make transactionalpackage x.y.service;
...
The corresponding integration classes reside in the `org.springframework.oxm.jaxb`package.
...
site]. The Spring integration classes reside in the `org.springframework.oxm.jibx`package.
