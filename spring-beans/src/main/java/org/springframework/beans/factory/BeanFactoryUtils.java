...
public abstract class BeanFactoryUtils {
	...
	public static String transformedBeanName(String name) {
		...
		/*
		 * 若transformedBeanNameCache存在对应name的beanName值返回，
		 * 否则去除name的所有BeanFactory.FACTORY_BEAN_PREFIX(&)前缀，并缓存name和结果beanName的对应关系
		 */
